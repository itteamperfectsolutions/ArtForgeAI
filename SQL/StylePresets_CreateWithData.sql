-- ============================================================
-- StylePresets — Create table + seed all data (26 base + 21 regional)
...
IF NOT EXISTS (SELECT 1 FROM StylePresets WHERE Id = 26)
INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, IsActive, SortOrder) VALUES
...
-- ============================================================
-- OIL PAINTING NICHE STYLES (IDs 100–102)
-- ============================================================

IF NOT EXISTS (SELECT 1 FROM StylePresets WHERE Id = 100)
INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, IsActive, SortOrder) VALUES
(100, 'Palette Knife Impasto', 'Thick textured palette knife oil painting',
 ...
 'Artistic', N'🔪', '#E65100', 1, 9);

IF NOT EXISTS (SELECT 1 FROM StylePresets WHERE Id = 101)
INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, IsActive, SortOrder) VALUES
(101, 'Flemish Oil Masters', 'Jan van Eyck ultra-detailed luminous oil painting',
 ...
 'Artistic', N'💎', '#1B5E20', 1, 10);

IF NOT EXISTS (SELECT 1 FROM StylePresets WHERE Id = 102)
INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, IsActive, SortOrder) VALUES
(102, 'Expressionist Oil', 'Van Gogh & Munch bold emotional oil painting',
 ...
 'Artistic', N'🌊', '#FF6D00', 1, 11);

-- ============================================================
-- INDIANISED OIL PAINTING STYLES (IDs 103–105)
-- ============================================================

IF NOT EXISTS (SELECT 1 FROM StylePresets WHERE Id = 103)
INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, IsActive, SortOrder) VALUES
(103, 'Ravi Varma Oil', 'Raja Ravi Varma classical Indian oil portraiture',
 ...
 'Artistic', N'🪷', '#B71C1C', 1, 12);

IF NOT EXISTS (SELECT 1 FROM StylePresets WHERE Id = 104)
INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, IsActive, SortOrder) VALUES
(104, 'Tanjore Gold Oil', 'South Indian Thanjavur gold-leaf oil painting',
 ...
 'Artistic', N'🛕', '#FF8F00', 1, 13);

IF NOT EXISTS (SELECT 1 FROM StylePresets WHERE Id = 105)
INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, IsActive, SortOrder) VALUES
(105, 'Bengal School Oil', 'Abanindranath Tagore dreamlike Indian oil art',
 ...
 'Artistic', N'🎨', '#5D4037', 1, 14);

-- ============================================================
-- BAPU BOMMA — Telugu iconic art (ID 106)
-- ============================================================

IF NOT EXISTS (SELECT 1 FROM StylePresets WHERE Id = 106)
INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, IsActive, SortOrder) VALUES
...
-- ============================================================
-- TRENDING 2025-2026: ARTISTIC (7 new, SortOrder 48-54)
-- ============================================================
...
-- ============================================================
-- TRENDING 2025-2026: FUN (7 new, SortOrder 55-61)
-- ============================================================
...
-- ============================================================
-- TRENDING 2025-2026: PROFESSIONAL (7 new, SortOrder 62-68)
-- ============================================================
...
-- ============================================================
-- TRENDING 2025-2026: ABSTRACT (7 new, SortOrder 69-75)
-- ============================================================
...
-- ============================================================
-- TRENDING 2025-2026: REGIONAL (7 new, SortOrder 76-82)
-- ============================================================
