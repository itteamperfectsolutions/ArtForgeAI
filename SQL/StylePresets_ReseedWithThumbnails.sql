-- ============================================================
-- StylePresets — FULL RESEED with ThumbnailPath
-- ArtForgeAI — Quick Style feature
-- Run this on production SQL Server after placing thumbnail
-- images in wwwroot/images/styles/
-- ============================================================
...
-- Reset identity
DBCC CHECKIDENT ('StylePresets', RESEED, 0);
GO
...
INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, ThumbnailPath, IsActive, SortOrder) VALUES
(1, 'Anime', 'Japanese anime illustration style',
 ...
 'Artistic', N'🎌', '#E91E63', 'images/styles/anime.jpg', 1, 1);
...
(2, 'Manga', 'Black & white Japanese manga',
 ...
 'Artistic', N'📖', '#263238', 'images/styles/manga.jpg', 1, 2);
...
(3, 'Oil Painting', 'Classical oil painting on canvas',
 ...
 'Artistic', N'🖼️', '#8D6E63', 'images/styles/oil-painting.jpg', 1, 3);
...
(4, 'Watercolor', 'Delicate watercolor painting',
 ...
 'Artistic', N'🎨', '#42A5F5', 'images/styles/watercolor.jpg', 1, 4);
...
(5, 'Charcoal', 'Expressive charcoal drawing',
 ...
 'Artistic', N'🖤', '#37474F', 'images/styles/charcoal.jpg', 1, 5);
...
(6, 'Impressionist', 'Monet/Renoir painting style',
 ...
 'Artistic', N'🌻', '#7E57C2', 'images/styles/impressionist.jpg', 1, 6);
...
(7, 'Vintage/Retro', 'Faded retro photograph look',
 ...
 'Artistic', N'📷', '#FF8F00', 'images/styles/vintage-retro.jpg', 1, 7);
...
(8, 'Flower Petals', 'Portrait made of flower petals',
 ...
 'Artistic', N'🌸', '#F06292', 'images/styles/flower-petals.jpg', 1, 8);
...
(9, 'Cartoon', 'Vibrant cartoon illustration',
 ...
 'Fun', N'🎪', '#FF5722', 'images/styles/cartoon.jpg', 1, 9);
...
(10, 'Pop Art', 'Bold Warhol-style pop art',
 ...
 'Fun', N'💥', '#F44336', 'images/styles/pop-art.jpg', 1, 10);
...
(11, 'Pixel Art', 'Retro 16-bit pixel style',
 ...
 'Fun', N'🕹️', '#4CAF50', 'images/styles/pixel-art.jpg', 1, 11);
...
(12, 'Comic', 'Comic book illustration',
 ...
 'Fun', N'💬', '#2196F3', 'images/styles/comic.jpg', 1, 12);
...
(13, 'Clay/Claymation', 'Charming claymation style',
 ...
 'Fun', N'🏺', '#FF9800', 'images/styles/clay-claymation.jpg', 1, 13);
...
(14, 'Caricature', 'Exaggerated fun caricature',
 ...
 'Fun', N'😜', '#E040FB', 'images/styles/caricature.jpg', 1, 14);
...
(15, 'Neon Glow', 'Glowing neon light style',
 ...
 'Fun', N'💡', '#00E5FF', 'images/styles/neon-glow.jpg', 1, 15);

-- ============================================================
-- PROFESSIONAL (IDs 16–21, 26)
-- ============================================================
...
(16, 'Sketch', 'Detailed pencil sketch',
 ...
 'Professional', N'✏️', '#78909C', 'images/styles/sketch.jpg', 1, 16);
...
(17, '3D Render', 'Hyper-detailed 3D render',
 ...
 'Professional', N'🎲', '#5C6BC0', 'images/styles/3d-render.jpg', 1, 17);
...
(18, 'Vector Art', 'Clean geometric vector style',
 ...
 'Professional', N'📐', '#26A69A', 'images/styles/vector-art.jpg', 1, 18);
...
(19, 'Line Art', 'Elegant ink line illustration',
 ...
 'Professional', N'📝', '#546E7A', 'images/styles/line-art.jpg', 1, 19);
...
(20, 'Gold/Metallic', 'Golden statue effect',
 ...
 'Professional', N'👑', '#FFD600', 'images/styles/gold-metallic.jpg', 1, 20);
...
(21, 'Paparazzi', 'Celebrity red carpet shot',
 ...
 'Professional', N'📸', '#D32F2F', 'images/styles/paparazzi.jpg', 1, 21);

INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, ThumbnailPath, IsActive, SortOrder) VALUES
(26, 'Cinematic B&W Profile', 'Dramatic B&W layered side-profile portrait',
 'Identify every person in the source photo. The output MUST contain the EXACT same number of people — do NOT skip or merge anyone. CRITICAL: Each person has a UNIQUE face — different age, gender, face shape, nose, jawline, forehead, hair. You MUST preserve each person''s individual facial identity exactly. Do NOT make them look alike. Render each person as a dramatic side profile facing left. Stack all profiles vertically against a pure black background, largest at top to smallest at bottom, slightly overlapping. Each face must look exactly like that specific person from the source — a viewer should be able to identify who is who. Black and white high-contrast monochrome. Dramatic rim lighting from one side. Deep blacks, bright highlights. Cinematic editorial portrait.',
 'Professional', N'🎞️', '#212121', 'images/styles/cinematic-bw-profile.jpg', 1, 22);
...
(22, 'Stained Glass', 'Cathedral stained glass design',
 ...
 'Abstract', N'🪟', '#AB47BC', 'images/styles/stained-glass.jpg', 1, 22);
...
(23, 'Low Poly', 'Geometric faceted art',
 ...
 'Abstract', N'🔷', '#1E88E5', 'images/styles/low-poly.jpg', 1, 23);
...
(24, 'Clouds/Dreamy', 'Ethereal cloud portrait',
 ...
 'Abstract', N'☁️', '#90CAF9', 'images/styles/clouds-dreamy.jpg', 1, 24);
...
(25, 'Surreal', 'Dali-inspired surrealism',
 ...
 'Abstract', N'🌀', '#FF6F00', 'images/styles/surreal.jpg', 1, 25);

-- ============================================================
-- OIL PAINTING NICHE (IDs 100–102)
-- ============================================================

INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, ThumbnailPath, IsActive, SortOrder) VALUES
(100, 'Palette Knife Impasto', 'Thick textured palette knife oil painting',
 'Transform into a vibrant palette knife impasto oil painting. CRITICAL: Preserve EVERY person in the image — do NOT remove, merge, or skip anyone. Keep all people at their correct relative sizes and positions. Thick, heavily textured paint applied with a palette knife creating bold three-dimensional ridges and peaks on the canvas. Rich saturated colors — deep cobalt blues, cadmium reds, golden yellows blended directly on the surface. Visible thick paint strokes catching light from different angles. Inspired by Leonid Afremov''s luminous rainy-city style. Modern impressionistic oil painting with dramatic color contrasts and tactile texture. Gallery-quality contemporary oil art.',
 'Artistic', N'🔪', '#E65100', 'images/styles/palette-knife-impasto.jpg', 1, 9);

INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, ThumbnailPath, IsActive, SortOrder) VALUES
(101, 'Flemish Oil Masters', 'Jan van Eyck ultra-detailed luminous oil painting',
 'Transform into an exquisite Flemish Old Masters oil painting in the style of Jan van Eyck and Rogier van der Weyden. CRITICAL: Preserve EVERY person in the image — do NOT remove, merge, or skip anyone. Keep all people at their correct relative sizes and positions. Microscopic hyper-detailed rendering — every strand of hair, fabric thread, and skin pore meticulously painted. Luminous jewel-like colors achieved through dozens of transparent oil glazing layers on white gesso ground. Rich saturated hues of lapis lazuli blue, vermillion red, and emerald green. Atmospheric perspective with crystalline clarity. Soft diffused northern light from a window. Elaborate textures — velvet, fur, polished metal, translucent gems rendered with photographic precision. 15th century Netherlandish masterpiece quality.',
 'Artistic', N'💎', '#1B5E20', 'images/styles/flemish-oil-masters.jpg', 1, 10);

INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, ThumbnailPath, IsActive, SortOrder) VALUES
(102, 'Expressionist Oil', 'Van Gogh & Munch bold emotional oil painting',
 'Transform into a bold Expressionist oil painting in the style of Van Gogh and Edvard Munch. CRITICAL: Preserve EVERY person in the image — do NOT remove, merge, or skip anyone. Keep all people at their correct relative sizes and positions. Thick swirling brushstrokes radiating with emotional energy. Vivid distorted colors — electric blues, burning oranges, deep purples that convey raw psychological intensity. Bold visible directional brushwork creating rhythmic movement across the canvas. Starry Night-inspired turbulent skies and pulsating backgrounds. Forms slightly abstracted and elongated with emotional distortion. Dramatic complementary color contrasts heightening the mood. Post-Impressionist modern art masterpiece quality.',
 'Artistic', N'🌊', '#FF6D00', 'images/styles/expressionist-oil.jpg', 1, 11);

-- ============================================================
-- INDIANISED OIL PAINTING (IDs 103–105)
-- ============================================================

INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, ThumbnailPath, IsActive, SortOrder) VALUES
(103, 'Ravi Varma Oil', 'Raja Ravi Varma classical Indian oil portraiture',
 'Transform into a classical Indian oil painting in the style of Raja Ravi Varma. CRITICAL: Preserve EVERY person in the image — do NOT remove, merge, or skip anyone. Keep all people at their correct relative sizes and positions. European academic realism blended with Indian aesthetic sensibility. Rich saturated oil colors with luminous skin tones and smooth blending. Subjects dressed in traditional Indian attire — silk sarees with gold borders, ornate jewelry, and classical drapery. Warm golden lighting with soft shadows. Lush Indian botanical background — tropical flowers, temple architecture, or palatial interiors. Museum-quality Indian fine art masterpiece in the tradition of the father of modern Indian art.',
 'Artistic', N'🪷', '#B71C1C', 'images/styles/ravi-varma-oil.jpg', 1, 12);

INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, ThumbnailPath, IsActive, SortOrder) VALUES
(104, 'Tanjore Gold Oil', 'South Indian Thanjavur gold-leaf oil painting',
 'Transform into a magnificent Tanjore oil painting style from South India. CRITICAL: Preserve EVERY person in the image — do NOT remove, merge, or skip anyone. Keep all people at their correct relative sizes and positions. Rich embossed gold leaf highlights on jewelry, crowns, and ornamental borders. Vibrant jewel-tone colors — deep red, royal blue, emerald green, and brilliant gold. Semi-precious stone-like gem embellishments on the surface. Ornate decorative arch framing with intricate floral and geometric patterns. Round gentle facial features with large expressive eyes. Traditional South Indian temple art aesthetic with divine golden radiance. Thanjavur painting masterpiece quality.',
 'Artistic', N'🛕', '#FF8F00', 'images/styles/tanjore-gold-oil.jpg', 1, 13);

INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, ThumbnailPath, IsActive, SortOrder) VALUES
(105, 'Bengal School Oil', 'Abanindranath Tagore dreamlike Indian oil art',
 'Transform into a dreamlike Bengal School oil painting in the style of Abanindranath Tagore and Nandalal Bose. CRITICAL: Preserve EVERY person in the image — do NOT remove, merge, or skip anyone. Keep all people at their correct relative sizes and positions. Soft ethereal wash-like quality with muted pastel and earth tones — dusty rose, sage green, warm ochre, and misty blue. Gentle flowing brushstrokes with dreamy atmospheric haze. Indian nationalist art aesthetic celebrating indigenous beauty and mythology. Delicate elongated figures with graceful poses reminiscent of Ajanta cave murals. Subtle gold accents and soft diffused lighting. Romantic, nostalgic, spiritually evocative. Early 20th century Indian art renaissance masterpiece quality.',
 'Artistic', N'🎨', '#5D4037', 'images/styles/bengal-school-oil.jpg', 1, 14);
...
INSERT INTO StylePresets (Id, Name, Description, PromptTemplate, Category, IconEmoji, AccentColor, ThumbnailPath, IsActive, SortOrder) VALUES
(106, 'Bapu Bomma', 'Legendary Telugu artist Bapu''s iconic illustration style',
 'Transform into the iconic Bapu Bomma illustration style of legendary Telugu artist Bapu (Sattiraju Lakshmi Narayana). CRITICAL: Preserve EVERY person in the image — do NOT remove, merge, or skip anyone. Keep all people at their correct relative sizes and positions. Distinctive clean precise ink linework with elegant flowing contours. Beautiful rounded faces with large expressive almond-shaped eyes, delicate pointed chins, and gentle smiles. Slender graceful figures with classical Indian poses and expressive hand gestures. Traditional South Indian attire — flowing silk sarees with intricate border patterns, jasmine flowers in hair, temple jewelry. Soft pastel coloring with warm skin tones — peach, cream, and golden hues. Minimal uncluttered backgrounds with subtle floral or nature motifs. The unmistakable Bapu aesthetic — grace, beauty, and cultural elegance of Telugu womanhood. Calendar art and Telugu cinema poster illustration quality.',
 'Regional', N'✍️', '#E91E63', 'images/styles/bapu-bomma.jpg', 1, 47);

SET IDENTITY_INSERT StylePresets OFF;
GO

-- ============================================================
-- REGIONAL — AP & Telangana (21 presets, auto IDs)
-- ============================================================
...
('Kalamkari', 'Traditional Kalamkari hand-painted textile art',
 ...
 'Regional', N'🎨', '#8B4513', 'images/styles/kalamkari.jpg', 1, 26),
...
('Cheriyal Scroll', 'Telangana Cheriyal scroll narrative painting',
 ...
 'Regional', N'📜', '#D84315', 'images/styles/cheriyal-scroll.jpg', 1, 27),
...
('Kondapalli Toys', 'Colorful Kondapalli wooden toy style',
 ...
 'Regional', N'🪆', '#FFB300', 'images/styles/kondapalli-toys.jpg', 1, 28),
...
('Bidri Ware', 'Bidar metalwork with silver inlay patterns',
 ...
 'Regional', N'⚱️', '#37474F', 'images/styles/bidri-ware.jpg', 1, 29),
...
('Pochampally Ikat', 'Pochampally ikat weaving geometric patterns',
 ...
 'Regional', N'🧵', '#7B1FA2', 'images/styles/pochampally-ikat.jpg', 1, 30),
...
('Nirmal Painting', 'Nirmal art gold-leaf painting tradition',
 ...
 'Regional', N'🖌️', '#C62828', 'images/styles/nirmal-painting.jpg', 1, 31),
...
('Tirupati Golden', 'Tirumala temple golden divine aesthetic',
 ...
 'Regional', N'🛕', '#FFD600', 'images/styles/tirupati-golden.jpg', 1, 32),
...
('Lepakshi Mural', 'Vijayanagara-era Lepakshi temple fresco',
 ...
 'Regional', N'🏛️', '#E65100', 'images/styles/lepakshi-mural.jpg', 1, 33),
...
('Bathukamma', 'Telangana Bathukamma floral festival art',
 ...
 'Regional', N'🌺', '#E91E63', 'images/styles/bathukamma.jpg', 1, 34),
...
('Bonalu Festival', 'Vibrant Bonalu festival celebration style',
 ...
 'Regional', N'🪔', '#F44336', 'images/styles/bonalu-festival.jpg', 1, 35),
...
('Kuchipudi Dance', 'Classical Kuchipudi dance-pose art',
 ...
 'Regional', N'💃', '#AD1457', 'images/styles/kuchipudi-dance.jpg', 1, 36),
...
('Sankranti Rangoli', 'Makar Sankranti muggu/rangoli patterns',
 ...
 'Regional', N'🌀', '#FF6F00', 'images/styles/sankranti-rangoli.jpg', 1, 37),
...
('Tollywood Poster', 'Telugu cinema dramatic poster style',
 ...
 'Regional', N'🎬', '#1565C0', 'images/styles/tollywood-poster.jpg', 1, 38),
...
('Charminar Heritage', 'Hyderabad Charminar architectural style',
 ...
 'Regional', N'🕌', '#546E7A', 'images/styles/charminar-heritage.jpg', 1, 39),
...
('Mangalagiri Fabric', 'Mangalagiri handloom cotton weave texture',
 ...
 'Regional', N'👘', '#2E7D32', 'images/styles/mangalagiri-fabric.jpg', 1, 40),
...
('Etikoppaka Lacquer', 'Etikoppaka lacquer-turned toy art',
 ...
 'Regional', N'🎎', '#EF6C00', 'images/styles/etikoppaka-lacquer.jpg', 1, 41),
...
('Godavari Landscape', 'River Godavari natural scenic painting',
 ...
 'Regional', N'🌊', '#00838F', 'images/styles/godavari-landscape.jpg', 1, 42),
...
('Perini Warrior', 'Perini Sivatandavam warrior dance art',
 ...
 'Regional', N'⚔️', '#4E342E', 'images/styles/perini-warrior.jpg', 1, 43),
...
('Dharmavaram Silk', 'Dharmavaram pattu saree rich silk art',
 ...
 'Regional', N'🥻', '#880E4F', 'images/styles/dharmavaram-silk.jpg', 1, 44),
...
('Deccan Miniature', 'Deccan school miniature painting style',
 ...
 'Regional', N'🎴', '#5D4037', 'images/styles/deccan-miniature.jpg', 1, 45),
...
('Araku Valley Nature', 'Araku Valley tribal nature landscape',
 ...
 'Regional', N'🏔️', '#1B5E20', 'images/styles/araku-valley-nature.jpg', 1, 46);
GO

-- ============================================================
-- TRENDING 2025-2026: ARTISTIC (7 new)
-- ============================================================
...
('Ghibli Dreamscape', 'Studio Ghibli-inspired dreamy anime landscape',
 ...
 'Artistic', N'🏡', '#66BB6A', 'images/styles/ghibli-dreamscape.jpg', 1, 48);
...
('Dark Academia Portrait', 'Moody intellectual dark academia aesthetic',
 ...
 'Artistic', N'📚', '#4E342E', 'images/styles/dark-academia-portrait.jpg', 1, 49);
...
('Y2K Cyber Glam', 'Early 2000s futuristic cyber glamour',
 ...
 'Artistic', N'💿', '#E040FB', 'images/styles/y2k-cyber-glam.jpg', 1, 50);
...
('Ethereal Glow Portrait', 'Soft luminous glowing portrait with dreamy light',
 ...
 'Artistic', N'✨', '#FFD54F', 'images/styles/ethereal-glow-portrait.jpg', 1, 51);
...
('Cottagecore Fantasy', 'Idyllic pastoral cottagecore aesthetic',
 ...
 'Artistic', N'🌿', '#A5D6A7', 'images/styles/cottagecore-fantasy.jpg', 1, 52);
...
('Dark Fantasy Arcane', 'Dark painterly fantasy with magical energy',
 ...
 'Artistic', N'🗡️', '#6A1B9A', 'images/styles/dark-fantasy-arcane.jpg', 1, 53);
...
('Retro Bollywood Saree', 'Vintage 1960s-70s Bollywood glamour portrait',
 ...
 'Artistic', N'🥻', '#FF6F00', 'images/styles/retro-bollywood-saree.jpg', 1, 54);
GO

-- ============================================================
-- TRENDING 2025-2026: FUN (7 new)
-- ============================================================
...
('Action Figure Box', 'Collectible action figure in branded toy packaging',
 ...
 'Fun', N'🎁', '#FF7043', 'images/styles/action-figure-box.jpg', 1, 55);
...
('LEGO Minifigure', 'Classic LEGO minifigure brick character',
 ...
 'Fun', N'🧱', '#FDD835', 'images/styles/lego-minifigure.jpg', 1, 56);
...
('Chibi 3D Figurine', 'Adorable chibi vinyl collectible figure',
 ...
 'Fun', N'🧸', '#FF80AB', 'images/styles/chibi-3d-figurine.jpg', 1, 57);
...
('Disney Pixar 3D', 'Disney Pixar animated movie character style',
 ...
 'Fun', N'🏰', '#7E57C2', 'images/styles/disney-pixar-3d.jpg', 1, 58);
...
('Trading Card Hero', 'Epic fantasy trading card game artwork',
 ...
 'Fun', N'🃏', '#7C4DFF', 'images/styles/trading-card-hero.jpg', 1, 59);
...
('Bollywood Retro Poster', 'Hand-painted 1970s-80s Hindi film poster',
 ...
 'Fun', N'🎬', '#D50000', 'images/styles/bollywood-retro-poster.jpg', 1, 60);
...
('Indian TV Serial Drama', 'Over-the-top dramatic Indian TV serial freeze frame',
 ...
 'Fun', N'📺', '#FF5722', 'images/styles/indian-tv-serial-drama.jpg', 1, 61);
GO

-- ============================================================
-- TRENDING 2025-2026: PROFESSIONAL (7 new)
-- ============================================================
...
('Corporate Headshot', 'Professional LinkedIn corporate headshot',
 ...
 'Professional', N'💼', '#1B3A5C', 'images/styles/corporate-headshot.jpg', 1, 62);
...
('Magazine Cover Star', 'High-fashion glossy magazine cover portrait',
 ...
 'Professional', N'📰', '#8B0000', 'images/styles/magazine-cover-star.jpg', 1, 63);
...
('Currency Engraving', 'Detailed banknote currency engraving portrait',
 ...
 'Professional', N'🏦', '#2E5233', 'images/styles/currency-engraving.jpg', 1, 64);
...
('Double Exposure City', 'Cinematic double exposure with city skyline',
 ...
 'Professional', N'🏙️', '#1A237E', 'images/styles/double-exposure-city.jpg', 1, 65);
...
('Bronze Sculpture Bust', 'Classical bronze sculpture bust with patina',
 ...
 'Professional', N'🗿', '#6D4C2A', 'images/styles/bronze-sculpture-bust.jpg', 1, 66);
...
('Passport Photo Pro', 'Perfect specification-compliant passport photograph',
 ...
 'Professional', N'🪪', '#1976D2', 'images/styles/passport-photo-pro.jpg', 1, 67);
...
('Blueprint Portrait', 'Technical architectural blueprint schematic',
 ...
 'Professional', N'📐', '#0D47A1', 'images/styles/blueprint-portrait.jpg', 1, 68);
GO

-- ============================================================
-- TRENDING 2025-2026: ABSTRACT (7 new)
-- ============================================================
...
('Ink in Water', 'Hypnotic flowing ink dissolving in water',
 ...
 'Abstract', N'🫧', '#1A237E', 'images/styles/ink-in-water.jpg', 1, 69);
...
('Glitch Art', 'Digital corruption glitch art aesthetic',
 ...
 'Abstract', N'📟', '#00BFA5', 'images/styles/glitch-art.jpg', 1, 70);
...
('Vaporwave', 'Retro-futuristic vaporwave aesthetic',
 ...
 'Abstract', N'🌴', '#E040FB', 'images/styles/vaporwave.jpg', 1, 71);
...
('Kaleidoscope', 'Sacred geometry kaleidoscope mandala pattern',
 ...
 'Abstract', N'🔮', '#AA00FF', 'images/styles/kaleidoscope.jpg', 1, 72);
...
('Fractal Bloom', 'Mathematical fractal art with organic blooming patterns',
 ...
 'Abstract', N'🧬', '#304FFE', 'images/styles/fractal-bloom.jpg', 1, 73);
...
('Aurora Portrait', 'Northern lights aurora borealis portrait',
 ...
 'Abstract', N'🌌', '#00C853', 'images/styles/aurora-portrait.jpg', 1, 74);
...
('Holographic Prism', 'Iridescent holographic rainbow light refraction',
 ...
 'Abstract', N'💠', '#00E5FF', 'images/styles/holographic-prism.jpg', 1, 75);
GO

-- ============================================================
-- TRENDING 2025-2026: REGIONAL (7 new)
-- ============================================================
...
('Madhubani Mithila', 'Bihar Madhubani folk painting with natural dyes',
 ...
 'Regional', N'🪷', '#C62828', 'images/styles/madhubani-mithila.jpg', 1, 76);
...
('Warli Tribal', 'Maharashtra Warli tribal art with geometric figures',
 ...
 'Regional', N'🏠', '#5D4037', 'images/styles/warli-tribal.jpg', 1, 77);
...
('Pattachitra Odisha', 'Odisha Pattachitra cloth scroll painting',
 ...
 'Regional', N'🎭', '#E65100', 'images/styles/pattachitra-odisha.jpg', 1, 78);
...
('Gond Tribal', 'Madhya Pradesh Gond tribal dot-and-line art',
 ...
 'Regional', N'🦚', '#1565C0', 'images/styles/gond-tribal.jpg', 1, 79);
...
('Kerala Mural', 'Kerala temple mural painting tradition',
 ...
 'Regional', N'🪔', '#2E7D32', 'images/styles/kerala-mural.jpg', 1, 80);
...
('Phulkari Punjab', 'Punjab Phulkari embroidery textile art',
 ...
 'Regional', N'🌸', '#FF6F00', 'images/styles/phulkari-punjab.jpg', 1, 81);
...
('Rajput Miniature', 'Rajasthan Rajput court miniature painting',
 ...
 'Regional', N'👑', '#7B1FA2', 'images/styles/rajput-miniature.jpg', 1, 82);
GO

-- ============================================================
-- PHOTO COLLAGE MIX, EMOTIONS COLLAGE, DECADES COLLAGE
-- (Adding if they exist in your current DB — check names)
-- ============================================================

-- Verify counts
SELECT Category, COUNT(*) AS [Count] FROM StylePresets GROUP BY Category ORDER BY Category;
SELECT COUNT(*) AS [Total] FROM StylePresets;
GO
