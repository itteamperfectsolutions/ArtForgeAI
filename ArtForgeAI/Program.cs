...
builder.Services.AddHttpClient<IGeminiVideoService, GeminiVideoService>(client =>
{
...
");
    ...
    var incrementalStyles = new[]
    {
        ...
        new {
            Name        = "Felt Craft Folk Art",
            Description = "Whimsical felt fabric craft scene with colorful cut-felt characters and nature",
            Prompt      = @"Transform this entire photo into a flat 2D felt fabric appliqué craft artwork — like a handmade felt collage pinned to a board. IDENTITY LOCK (CRITICAL): The person's face must remain recognizable and preserve their exact identity, facial features, skin tone, and expression. No face swap, no reshaping, no beautification. The face should have a felt-fabric texture overlay but the identity must be unmistakable. FULL FELT TRANSFORMATION: EVERYTHING in the image — the person, their clothing, hair, AND the background — must look like it is made from flat cut-felt fabric pieces layered on top of each other. The person's body, clothes, and hair should appear as flat felt cutouts with visible felt texture, soft fuzzy edges, and hand-cut shapes. NOT a real person on a felt background — the ENTIRE scene is felt craft. BACKGROUND: A felt-craft nature scene — bright blue felt sky, a brown felt tree trunk with colorful felt leaves (orange, yellow, teal, green), cute felt owls or birds on branches, felt flowers and green felt grass along the bottom. All elements are flat 2D felt cutouts with slight layered depth. TECHNIQUE: Each element looks like it was hand-cut from colored felt sheets and layered/glued together. Visible felt fabric texture on every surface. Soft fuzzy edges on all cutout shapes. Slight dimensional layering between pieces (like a real felt craft project). Simple stitching details where felt pieces meet. LIGHTING: Flat, even, soft — as if photographing a real felt craft board from directly above. Minimal shadows, just enough to show layering. COLOR PALETTE: Saturated felt colors — sky blue, grass green, sunny yellow, warm orange, teal, pink, crimson, brown. Cheerful and vibrant. ART STYLE: Flat 2D handmade felt fabric appliqué art — like photographing a real felt craft board. NOT 3D, NOT photorealistic, NOT digital art. The entire image should look like a physical felt craft project. STRICT RULES: Identity must be preserved and recognizable. No text, no names, no watermarks. No anatomical errors.",
            Category    = "Artistic",
            Emoji       = "\U0001F9F5",  // 🧵
            Color       = "#4DB6AC",
            SortOrder   = 266
        ...
        new {
            Name        = "Tufted Rug Portrait",
            Description = "Handmade tufted carpet art with fuzzy looped pile texture like a punch needle rug",
            Prompt      = @"Transform this entire photo into a handmade tufted carpet / punch needle rug artwork. IDENTITY LOCK (CRITICAL): The person's face must remain recognizable — preserve their exact identity, facial features, skin tone, and expression. No face swap, no reshaping, no beautification. The face should be rendered in the tufted rug texture but the identity must be unmistakable. FULL RUG TEXTURE TRANSFORMATION: The ENTIRE image — person, clothing, hair, background, every element — must look like it is made from tufted loop-pile carpet fibers. Like a handmade punch needle rug or hooked rug wall hanging. Every surface has a dense, fuzzy, looped yarn texture. NOT flat felt — this is thick, plush, carpet-like tufted fiber with visible individual loops and pile height. BACKGROUND: A tufted rug scene — a large tree with dark brown tufted trunk and branches, colorful tufted leaves in orange, yellow, teal, green, and lime. Cute tufted owls and small birds perched on branches. Tufted flowers and grass at the bottom. Light blue/periwinkle tufted sky. All elements rendered as areas of differently colored tufted yarn on the same rug surface. TECHNIQUE: Dense loop-pile tufted texture everywhere — like looking at a close-up of a handmade carpet. Each color area is filled with tiny loops of colored yarn. Colors meet with clear boundaries like a hand-tufted rug design. Visible fuzzy fiber texture across every surface. Slight dimensional quality from the pile height. The entire image looks like a photograph of an actual handmade tufted rug. LIGHTING: Even, flat, front-lit — as if photographing a rug hanging on a wall. Soft shadows only from the pile texture itself. COLOR PALETTE: Carpet yarn colors — periwinkle blue, dark brown, pink, orange, golden yellow, teal, lime green, cream, dotted accent patterns in contrasting colors. Warm and cheerful. ART STYLE: Handmade tufted rug / punch needle textile art. The image should be indistinguishable from a photo of an actual handcrafted carpet wall hanging. NOT digital, NOT smooth, NOT illustrated. STRICT RULES: Identity must be preserved and recognizable. No text, no names, no watermarks. No anatomical errors.",
            Category    = "Artistic",
            Emoji       = "\U0001F9F6",  // 🧶
            Color       = "#E91E63",
            SortOrder   = 267
        ...
        new {
            Name        = "Embroidery Stitch Art",
            Description = "Delicate hand-embroidered portrait with fine thread stitches on linen fabric",
            Prompt      = @"Transform this entire photo into a delicate hand-embroidered artwork on natural linen fabric. IDENTITY LOCK (CRITICAL): The person's face must remain recognizable — preserve their exact identity, facial features, skin tone, and expression. No face swap, no reshaping, no beautification. No skin tone change. No facial structure modification. The face is rendered with fine embroidery stitches but identity must be unmistakable. EMBROIDERY STYLE: The ENTIRE image — person, clothing, hair, background — is rendered as fine hand-embroidery on a visible natural linen/cotton fabric base. Use delicate, thin thread stitches — satin stitch for smooth filled areas, long-and-short stitch for shading and gradients, stem stitch for outlines and details, French knots for small texture dots. The thread is fine and lightweight — NOT thick yarn, NOT carpet pile, NOT chunky. Think elegant hand embroidery hoop art. BACKGROUND: A gently embroidered nature scene — soft pastel flowers, thin-stemmed leaves, small delicate birds or butterflies, all in fine thread on the visible linen base fabric. The linen weave texture shows through in unfilled areas. Simple, airy, not overly dense. TECHNIQUE: Fine individual thread stitches visible throughout — you can see the direction and texture of each stitch. The linen base fabric is visible between stitched areas. Colors blend through overlapping fine stitches, not solid blocks. Delicate and refined, like museum-quality hand embroidery. Thread has a subtle sheen like cotton or silk embroidery floss. LIGHTING: Soft natural light as if photographing embroidery in a frame. Subtle texture from the raised thread on fabric. COLOR PALETTE: Soft embroidery thread colors — muted rose, sage green, dusty blue, cream, soft gold, warm brown, gentle coral. Elegant and understated, not loud or saturated. ART STYLE: Fine hand embroidery / needlework portrait art on linen. Should look like a photograph of actual framed embroidery. Delicate, refined, artisanal. NOT thick rug, NOT felt, NOT digital illustration. STRICT RULES: Identity must be preserved and recognizable. No text, no names, no watermarks. No anatomical errors. Preserve natural body proportions.",
            Category    = "Artistic",
            Emoji       = "\U0001FAA1",  // 🪡
            Color       = "#CE93D8",
            SortOrder   = 268
        ...
        new {
            Name        = "Romantic Rain Night",
            Description = "Couple in dramatic nighttime rain with cinematic reflections and warm bokeh lighting",
            Prompt      = @"Create a romantic Bollywood-style rain collage with TWO scenes in ONE image. IDENTITY LOCK (CRITICAL): Preserve the EXACT facial features, identity, skin tone of every person — no modifications to faces. No face swap, no reshaping, no beautification. LAYOUT (CRITICAL — TWO SCENES): The image is a COMPOSITE COLLAGE blending two scenes together seamlessly: TOP 70% — LARGE CLOSE-UP: An extreme close-up of the couple's faces filling the upper portion. Foreheads gently touching, noses almost meeting, eyes softly closed, both wearing warm gentle SMILES — happy and in love, not serious or sad. Their faces are the main focus. Visible water droplets on their skin — on foreheads, cheeks, eyelashes. Hair completely wet and clinging. Rain drops caught mid-air around them, brightly backlit. The woman wears traditional Indian jewelry — earrings, small nose pin, maang tikka. Man wears a dark black shirt. Dark background behind them. BOTTOM 30% — SMALL FULL-BODY INSET: A smaller full-body shot of the SAME couple dancing or embracing joyfully in heavy rain. They stand on a wet reflective surface — the ground is like a golden mirror reflecting their entire bodies and the warm lights above. The woman wears a vibrant yellow/golden traditional saree or lehenga, the man wears dark clothing. Heavy rain streaks visible around them. Warm golden lighting from behind. This inset blends naturally into the close-up above — no hard border, the two scenes merge smoothly with rain as the connecting element. RAIN THROUGHOUT: Dense bright rain streaks filling the entire image from top to bottom, backlit and glowing white-silver against the dark background. Rain connects both scenes visually. LIGHTING: Warm golden-amber backlight making rain glow. Rim light on subjects. Water droplets sparkle on skin. Dark moody background with warm highlights on the couple. COLOR PALETTE: Dark black background, warm golden skin tones, bright water highlights, silver rain, golden reflections on wet ground in the lower scene. Yellow/gold saree adds a pop of color. MOOD: Joyful romantic — happy smiles, gentle intimacy, Bollywood rain song energy. Beautiful, not melancholy. STRICT RULES: Faces 100% identity-preserved. No text, no watermarks. No anatomical errors.",
            Category    = "Trendy Photo Collage",
            Emoji       = "\U0001F4A7",  // 💧
            Color       = "#1A237E",
            SortOrder   = 220
        },
        new {
            Name        = "Pixar Heart Glow",
            Description = "Disney Pixar 3D animated couple making a heart with glowing neon light trail",
            Prompt      = @"Transform this photo into a Disney Pixar-style 3D animated portrait. IDENTITY PRESERVATION: The animated characters must be clearly recognizable as the same people — preserve their distinctive facial features, hairstyle, hair color, skin tone, and overall look. Translate their real appearance into the Pixar 3D animation style while keeping them identifiable. STYLE: High-quality 3D CGI animation in the style of Disney Pixar movies (like Coco, Encanto, Up). Smooth rounded features, expressive large eyes with detailed reflections, soft skin with subtle subsurface scattering, stylized but recognizable faces. Not photorealistic — this is a charming 3D cartoon. POSE (CRITICAL): The couple faces the camera in a close-up selfie-style framing. They each extend one hand toward the camera and their hands meet to form a HEART SHAPE together — one person's hand makes the left half, the other's hand makes the right half of the heart. Their fingers touch at the top and palms meet at the bottom creating a clear heart silhouette. Big warm happy smiles on both faces. GLOWING LIGHT TRAIL (CRITICAL): A bright glowing neon cyan-blue light trail swirls elegantly around the couple — looping around their shoulders, between them, and around the heart shape their hands make. The light trail is a thin continuous glowing line like a magical sparkle path or light painting. It emits a soft cyan-blue glow on nearby surfaces. The trail adds a magical, enchanted quality to the scene. BACKGROUND: Bright cheerful blue sky with soft fluffy white clouds. Sunlit, warm, optimistic — classic Pixar outdoor sky. Clean and simple to keep focus on the couple. CLOTHING: Casual modern clothing matching what they wear in the original photo, rendered in the 3D animated style. LIGHTING: Bright warm sunlight from above/behind. Soft fill light on faces. The neon glow trail adds cool cyan accent lighting. Clean, cheerful Pixar movie lighting. COLOR PALETTE: Bright sky blue, warm skin tones, cyan-blue neon glow, white clouds, colorful clothing. Vibrant and cheerful. ART STYLE: Disney Pixar 3D CGI animation — movie-quality render. Charming, polished, appealing character design. STRICT RULES: Characters must be recognizable as the people in the photo. No text, no watermarks. No anatomical errors. Maintain natural body proportions adapted to Pixar style.",
            Category    = "Trendy Photo Collage",
            Emoji       = "\U0001F49C",  // 💜
            Color       = "#00BCD4",
            SortOrder   = 221
        ...
        new {
            Name        = "Cinematic Bokeh Night",
            Description = "Moody nighttime portrait in traditional attire with warm golden city bokeh lights",
            Prompt      = @"Transform this photo into a cinematic nighttime bokeh portrait. IDENTITY LOCK (CRITICAL): Preserve the EXACT facial features, identity, skin tone, facial hair, and appearance of the person — absolutely no modifications to the face. No face swap, no reshaping, no beautification, no skin tone change, no smoothing. Face must remain 100% photorealistic and untouched. SKIN TONE PRESERVATION: Maintain original skin tone, undertone, and texture exactly. HUMAN ANATOMY PROTECTION: Preserve natural proportions. No distortion or anatomical errors. POSE AND EXPRESSION: The subject in a close-up to mid-shot, looking slightly downward or to the side with a thoughtful, intense, contemplative expression. Head slightly tilted. The mood is brooding, cinematic, and introspective — like a movie poster or high-end fashion editorial. ATTIRE: The subject wears elegant traditional Indian white or off-white clothing — a richly textured chikankari kurta or embroidered sherwani with intricate thread work visible on the fabric. The clothing has a luxurious, festive quality with detailed embroidery patterns. BACKGROUND (CRITICAL): Nighttime cityscape completely out of focus — just a sea of warm golden, amber, and soft white BOKEH CIRCLES. Dozens of large soft circular bokeh lights at varying sizes scattered across the entire background. The bokeh is the hero of the background — large, round, dreamy, overlapping circles of warm golden light from distant city lights, street lamps, and buildings. No sharp details in background, everything is beautifully blurred. LIGHTING: Dramatic cinematic side lighting or three-quarter lighting on the face — one side warmly lit with golden-amber tones, the other side falling into gentle shadow. The warm light matches the golden bokeh behind. Subtle rim light separating the subject from the background. The lighting is moody, dramatic, and flattering. COLOR PALETTE: Warm golden-amber bokeh, deep dark night tones, warm skin highlights, white/cream traditional clothing, rich contrast between light and shadow. Cinematic color grading — warm highlights, cool shadows. MOOD: Cinematic, introspective, elegant, dramatic — like a premium fashion or festive editorial shoot. The subject looks powerful and contemplative against the dreamy night lights. ART STYLE: High-end cinematic portrait photography with shallow depth of field. Magazine cover quality. Photorealistic. STRICT RULES: Face must remain 100% identity-preserved. No text, no names, no watermarks. No anatomical errors.",
            Category    = "Trendy Photo Collage",
            Emoji       = "\U0001F307",  // 🌇
            Color       = "#FF8F00",
            SortOrder   = 222
        ...
        new {
            ...
            Description = "Hyper-detailed graphite pencil drawing on white paper with fine shading",
            Prompt      = @"Transform this photo into a hyper-detailed graphite pencil sketch on white paper. IDENTITY LOCK (CRITICAL): The person's face must remain EXACTLY the same — preserve every facial feature, structure, expression, and likeness with precision. The sketch must be unmistakably the same person. No beautification, no reshaping, no changes to facial structure, eyes, nose, lips, or jawline. STYLE: A masterful hand-drawn graphite pencil portrait on clean white paper. Fine detailed pencil strokes for hair — individual strands visible with varying pressure creating depth and volume. Soft graduated shading on the face using light crosshatching and blending — subtle tonal transitions on cheeks, under eyes, jawline, and neck. The eyes are the most detailed element — precise highlights in the iris, detailed eyelashes, careful shading around the eye socket. Eyebrows rendered with fine individual hair strokes. Lips softly shaded with subtle highlights. TECHNIQUE: Use a range of pencil grades — light HB strokes for skin shading, darker 2B-4B for hair, eyebrows, and deepest shadows. White of the paper shows through as highlights on the forehead, nose bridge, and cheekbones. The neck and shoulders fade softly into white paper — the drawing doesn't have hard edges at the bottom, it gently dissolves. Visible pencil texture throughout. BACKGROUND: Clean white paper. No background elements. The portrait floats on white space. The edges of hair and shoulders softly blend into the white paper. COMPOSITION: Close-up portrait — head and upper shoulders. Slightly angled three-quarter view or matching the original photo's angle. The face is the hero — large, detailed, centered. LIGHTING: Translated from the original photo — maintain the same light direction. Light areas remain white paper, shadows are built with pencil strokes. Strong contrast between light and dark areas. COLOR: Pure black and white — graphite pencil on white paper. No color whatsoever. Full range of grays from lightest sketch lines to deep black in the darkest shadows. STRICT RULES: Identity must be 100% preserved. No color. No text, no watermarks. No anatomical errors. Must look like a hand-drawn pencil sketch, not a photo filter.",
            Category    = "Trendy Photo Collage",
            Emoji       = "\u270F\uFE0F",  // ✏️
            Color       = "#616161",
            SortOrder   = 223
        ...
        new {
            ...
            Description = "Collage with large side-profile close-up and full-body couple in royal blue traditional attire",
            Prompt      = @"Create a romantic collage composite with TWO scenes blended in ONE image. IDENTITY LOCK (CRITICAL): Preserve the EXACT facial features, identity, skin tone, and appearance of every person — no modifications to faces. No face swap, no reshaping, no beautification, no skin tone change. Faces must remain photorealistic and untouched. LAYOUT (TWO SCENES): TOP/RIGHT 60% — LARGE CLOSE-UP: A dramatic close-up of the woman's face in elegant side profile or three-quarter view, looking slightly downward or to the side with a serene graceful expression. She wears elaborate traditional Indian silver/diamond jhumka earrings and elegant jewelry. Her hair is dark and flowing. This close-up is large, filling the upper-right portion of the image with a dreamy soft blue-toned color grade. BOTTOM/LEFT 40% — FULL-BODY COUPLE: A smaller full-body shot of the couple together — the woman in a stunning royal blue traditional saree or lehenga with silver/gold embroidery, the man in a matching blue formal shirt or kurta. They stand close in a romantic pose — perhaps the man slightly behind, hand on her waist or holding her hand. Both looking elegant and poised. COLOR GRADING (CRITICAL): The ENTIRE image has a cohesive royal blue color tone — deep navy, sapphire blue, steel blue. Both scenes share this blue monochromatic grading. The close-up fades with a soft blue gradient into the full-body scene. No harsh borders between scenes — they blend seamlessly through blue tones and soft gradients. BACKGROUND: Soft dreamy blurred blue-toned background for both scenes — subtle bokeh or soft studio lighting. Clean and elegant. LIGHTING: Soft glamorous lighting on faces. The close-up has beautiful catchlights in the eyes and soft skin lighting. Elegant, editorial quality. MOOD: Royal, elegant, sophisticated — like a premium Indian fashion editorial or pre-wedding shoot poster. Regal and refined. STRICT RULES: Faces 100% identity-preserved. No text, no watermarks. No anatomical errors.",
            Category    = "Trendy Photo Collage",
            Emoji       = "\U0001F48E",  // 💎
            Color       = "#1565C0",
            SortOrder   = 224
        ...
        new {
            Name        = "Palace Sunset Romance",
            Description = "Collage with dreamy face close-up and couple at grand Indian palace in pink-purple sunset",
            Prompt      = @"Create a romantic collage composite with TWO scenes blended in ONE image. IDENTITY LOCK (CRITICAL): Preserve the EXACT facial features, identity, skin tone, and appearance of every person — no modifications to faces. No face swap, no reshaping, no beautification, no skin tone change. Faces must remain photorealistic and untouched. LAYOUT (TWO SCENES): TOP 55% — LARGE FACE CLOSE-UP: A large dreamy close-up of the woman's face — soft smile, beautiful eyes looking slightly to the side. She wears subtle traditional jewelry. The close-up is semi-transparent and fades softly into the scene below. It fills the upper portion like a dream or memory overlaying the sky. Soft pink-purple color grading. BOTTOM 45% — FULL-BODY COUPLE AT PALACE: The couple stands together in front of a grand Indian palace or historical monument (like a Mughal palace with domes and minarets). The woman wears a rich traditional saree (maroon/pink), the man wears a purple/blue floral printed shirt or kurta. They embrace romantically — close together, perhaps his arm around her waist or her head near his shoulder. BACKGROUND: A stunning pink-purple-golden sunset sky behind the palace. The palace silhouette is visible with warm sunset tones. Dreamy pink and purple clouds. Tiny sparkles or bokeh particles floating in the air adding a magical quality. SKY BLEND: The woman's large face close-up blends INTO the sunset sky — her face is like a vision appearing in the pink-purple clouds above the palace. The two scenes merge through color and transparency, not hard edges. COLOR PALETTE: Pink, purple, magenta, gold, warm amber. Dreamy romantic color grading throughout. MOOD: Magical, romantic, Bollywood poster quality — like a dream sequence in a love story. STRICT RULES: Faces 100% identity-preserved. No text, no watermarks. No anatomical errors.",
            Category    = "Trendy Photo Collage",
            Emoji       = "\U0001F3F0",  // 🏰
            Color       = "#AD1457",
            SortOrder   = 225
        ...
        new {
            Name        = "Floral Haldi Dream",
            Description = "Collage with flower-adorned face close-up and couple in festive Haldi ceremony colors",
            Prompt      = @"Create a romantic festive collage composite with TWO scenes blended in ONE image. IDENTITY LOCK (CRITICAL): Preserve the EXACT facial features, identity, skin tone, and appearance of every person — no modifications to faces. No face swap, no reshaping, no beautification, no skin tone change. Faces must remain photorealistic and untouched. LAYOUT (TWO SCENES): TOP 55% — LARGE FACE WITH FLOWERS: A beautiful large close-up of the woman's face with a gentle warm smile, looking slightly downward with soft happy eyes. FLOWERS IN HAIR (CRITICAL): She wears fresh colorful roses and flowers arranged in her hair — yellow roses, pink roses, and green leaves tucked along the side or back of her hair. She also wears elegant hoop earrings or traditional earrings. The close-up is dreamy and softly fades into the scene below. Soft pink-blue pastel color grading on this section. BOTTOM 45% — COUPLE IN FESTIVE ATTIRE: A smaller full-body shot of the couple in traditional Indian festive/Haldi ceremony clothing. The woman wears a yellow or golden traditional saree/lehenga, the man wears a colorful kurta or casual festive clothing. They stand close in a tender romantic pose — perhaps the man gently holding her hands or touching her face. Flowers visible around them too. BACKGROUND: Soft dreamy pastel bokeh — pink, blue, and golden bokeh circles filling the background. Sparkles and tiny light particles floating in the air. The overall background transitions from soft blue at the top to warm pink/golden at the bottom. No harsh borders between the two scenes — they blend through soft color gradients and bokeh. COLOR PALETTE: Soft pastels — baby pink, sky blue, golden yellow, rose pink, green leaf accents. Warm and festive but dreamy and soft. MOOD: Festive, joyful, romantic — like a beautiful Indian wedding Haldi ceremony celebration. Warm and happy. STRICT RULES: Faces 100% identity-preserved. No text, no watermarks. No anatomical errors.",
            Category    = "Trendy Photo Collage",
            Emoji       = "\U0001F338",  // 🌸
            Color       = "#F48FB1",
            SortOrder   = 226
        ...
        new {
            Name        = "Mountain Love Collage",
            Description = "Collage with transparent couple faces in sky and full-body at scenic mountain road with snow peaks",
            Prompt      = @"Create a romantic landscape collage composite with TWO scenes blended in ONE image. IDENTITY LOCK (CRITICAL): Preserve the EXACT facial features, identity, skin tone, and appearance of every person — no modifications to faces. No face swap, no reshaping, no beautification, no skin tone change. Faces must remain photorealistic and untouched. LAYOUT (TWO SCENES): TOP 50% — TRANSPARENT FACES IN SKY: The couple's faces appear LARGE and SEMI-TRANSPARENT in the sky above the mountains — like a double exposure or dream vision. Both faces in close-up, gazing at each other with foreheads nearly touching or looking tenderly at each other. The faces are blended into the clouds and sky with soft transparency — you can see the mountain peaks and clouds through their faces. The woman wears a light blue/teal traditional outfit, the man's face is visible in profile. This overlay creates a dreamy, ethereal quality. BOTTOM 50% — FULL-BODY AT MOUNTAIN ROAD: The same couple stands on a scenic mountain road stretching into the distance. Dramatic snow-capped Himalayan mountain peaks rise behind them. The woman wears an elegant light blue/teal saree with white lace border, the man wears a white kurta or formal outfit. They face each other in a romantic embrace on the road — intimate and tender. The road leads the eye from them toward the mountains. BLENDING: The faces in the sky merge seamlessly with the mountain landscape — no hard edges. The couple's transparent faces in the clouds are like a beautiful memory hovering above the real scene below. The transition from sky-faces to mountain-landscape is smooth and natural. COLOR PALETTE: Cool blue-teal tones, white snow, gray mountains, soft sky blue, touches of green. Cool and fresh mountain atmosphere. Clean and airy. MOOD: Epic, romantic, cinematic — love story set against majestic mountain scenery. Breathtaking and grand. STRICT RULES: Faces 100% identity-preserved. No text, no watermarks. No anatomical errors.",
            Category    = "Trendy Photo Collage",
            Emoji       = "\U0001F3D4\uFE0F",  // 🏔️
            Color       = "#546E7A",
            SortOrder   = 227
        ...
        new {
            Name        = "Starry Floral Couple",
            Description = "Collage with dreamy face close-up and couple in vibrant floral outfits against cosmic blue-purple bokeh",
            Prompt      = @"Create a romantic cosmic collage composite with TWO scenes blended in ONE image. IDENTITY LOCK (CRITICAL): Preserve the EXACT facial features, identity, skin tone, and appearance of every person — no modifications to faces. No face swap, no reshaping, no beautification, no skin tone change. Faces must remain photorealistic and untouched. LAYOUT (TWO SCENES): TOP/LEFT 55% — LARGE FACE CLOSE-UP: A beautiful large close-up of the woman's face — serene elegant expression, looking slightly to the side with soft eyes. She wears elegant diamond or crystal drop earrings. Her hair is styled beautifully. The close-up has a dreamy quality and fades softly into the cosmic background. Semi-transparent edges blending into the starry bokeh. BOTTOM/RIGHT 45% — FULL-BODY COUPLE IN FLORAL OUTFITS: The couple stands together in an intimate romantic pose. CLOTHING (CRITICAL): The man wears a vibrant floral-printed shirt or kurta — bold colorful flowers (pink, purple, orange) on a dark or blue base. The woman wears a rich deep red/maroon traditional saree with floral embroidery or floral prints, with gold/silver border. Their outfits are colorful and eye-catching — the floral patterns are a key visual element. They stand close together in a loving embrace. BACKGROUND (CRITICAL): The entire background is a cosmic deep blue-purple space with magical bokeh — large soft glowing circles of blue, purple, teal, and white scattered throughout. Tiny sparkles and star-like particles floating everywhere. The bokeh creates a dreamy magical starfield effect. Both scenes share this cosmic blue-purple bokeh background — it unifies the composition. BLENDING: The large face blends naturally into the cosmic background — no hard borders. The face appears to emerge from the starry bokeh. Both scenes connected by the shared magical background. COLOR PALETTE: Deep blue, purple, magenta, teal bokeh lights. Rich reds and pinks from floral outfits. Jewel tones throughout. Magical and vibrant. MOOD: Magical, glamorous, cosmic romance — like a fantasy fashion poster. Enchanting and visually rich. STRICT RULES: Faces 100% identity-preserved. No text, no watermarks. No anatomical errors.",
            Category    = "Trendy Photo Collage",
            Emoji       = "\U0001FA90",  // 🪐
            Color       = "#7B1FA2",
            SortOrder   = 228
        ...
        new {
            Name        = "Titanic Sunset Ship",
            Description = "Collage with couple faces in golden sky and Titanic-pose on cruise ship at sunset",
            Prompt      = @"Create a romantic Titanic-inspired collage composite with TWO scenes blended in ONE image. IDENTITY LOCK (CRITICAL): Preserve the EXACT facial features, identity, skin tone, and appearance of every person — no modifications to faces. No face swap, no reshaping, no beautification, no skin tone change. Faces must remain photorealistic and untouched. LAYOUT (TWO SCENES): TOP 50% — COUPLE FACES IN GOLDEN SKY: Both the man and woman's faces appear LARGE in the golden sunset sky — semi-transparent, like a dream vision. The man's face on one side, woman's face on the other, both gazing tenderly or with eyes gently closed. Warm smiles on both faces. Their faces blend into the golden-orange sunset clouds. You can see the warm sky colors through their semi-transparent faces. This creates a romantic dreamy double-exposure effect. BOTTOM 50% — TITANIC POSE ON SHIP: The couple recreates the iconic Titanic pose on the bow/railing of a cruise ship or large boat. The woman stands at the front with arms spread wide open, the man stands behind her holding her waist. Her red dupatta or scarf flies dramatically in the wind. They stand at the ship's railing overlooking the vast ocean. The sun is setting on the horizon — a large golden-orange sun sinking into the ocean, painting the sky and water with warm golden light. ATTIRE: The woman wears a green or teal traditional outfit or dress with a flowing red scarf/dupatta that catches the wind. The man wears casual or semi-formal clothing. BLENDING: The faces in the sky merge seamlessly into the sunset — the warm golden tones connect both scenes. No hard borders. The dream-faces hover naturally above the ship scene like a beautiful memory. COLOR PALETTE: Warm golden-orange sunset, deep amber, rich orange, silhouetted ship, dark ocean reflecting golden light. Red scarf adds a pop of color. Everything bathed in warm sunset tones. MOOD: Epic romantic — iconic Titanic moment recreated with Indian couple at golden hour. Cinematic, emotional, breathtaking. STRICT RULES: Faces 100% identity-preserved. No text, no watermarks. No anatomical errors. No brand logos on the ship.",
            Category    = "Trendy Photo Collage",
            Emoji       = "\U0001F6F3\uFE0F",  // 🛳️
            Color       = "#E65100",
            SortOrder   = 229
